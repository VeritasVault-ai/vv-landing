        ...
        <CardContent>
          <div className="space-y-4">
            <ReportItem
              ...
              period="April 2025"
              onDownload={() => handleDownloadReport("Monthly Performance Report", "April 2025")}
            />
            
            <ReportItem
              title="Risk Assessment Report"
              period="Q2 2025"
              onDownload={() => handleDownloadReport("Risk Assessment Report", "Q2 2025")}
            />
            
            <ReportItem
              title="Regulatory Compliance Report"
              period="Q2 2025"
              onDownload={() => handleDownloadReport("Regulatory Compliance Report", "Q2 2025")}
            />
          </div>
        </CardContent>
      </Card>
